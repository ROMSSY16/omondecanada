...
<div class="modal z-index-1 fade" id="addContactModal" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form class="contactForm" id="contactForm" action="{{ route('commercial.add_prospect') }}" method="POST" enctype="multipart/form-data" novalidate>
                    @csrf
                    <div class="row">
                    ...
                    <div class="row">
                        <div class="col-md-4 mb-3">
                            <div class="form-group">
                                <label for="pays" class="form-label">Pays</label>
                                <input type="text" name="pays" id="pays" class="form-control" value="{{$pays}}" disabled required>
                    ...
                    <div class="row">
                        <div class="col-md-7 mb-3">
                            <label for="q_rdv" class="form-label">Voulez-vous ajouter un Rendez-vous ?</label>
                        </div>
                        <div class="col-md-5 mb-3">
                            <div class="form-group">
                                <div class="form-check form-check-inline">
                                    <input type="radio" class="form-check-input" id="rdvOui" value="Oui" name="q_rdv">
                                    <label class="form-check-label" for="rdvOui">OUI</label>
                                </div>
                                <div class="form-check form-check-inline">
                                    <input type="radio" class="form-check-input" id="rdvNon" value="Non" name="q_rdv">
                                    <label class="form-check-label" for="rdvNon">NON</label>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div id="rdvForm" class="d-none">
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                <div class="form-group">
                                    <label for="consultant" class="form-label">Consultant(e)</label>
                                    <select name="consultant" id="consultant" class="form-control" required>
                                        <option value="" selected disabled> ----- Sélectionner ----- </option>
                                        @foreach($consultants as $consultant)
                                            <option value="{{ $consultant->id }}" {{ old('consultant') == $consultant->id ? 'selected' : '' }}>  
                            ...
                            <div class="col-md-6 mb-3">
                                <div class="form-group">
                                    <label for="date_rdv" class="form-label">Date Rendez Vous</label>
                                    <input type="date" name="date_rdv" id="date_rdv" class="form-control" value="{{old('date_rdv')}}">
                                </div>
                            </div>
                        </div>
                    </div>
...
<script>
    ...
    $('input[name="q_rdv"]').on('change', function () {
        if ($(this).val() === 'Oui') {
            $('#rdvForm').removeClass('d-none');
        } else {
            $('#rdvForm').addClass('d-none');
        }
    });
});
