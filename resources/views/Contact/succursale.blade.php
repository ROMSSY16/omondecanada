                                                    ...
                                                    <form action="{{ route('contact.update', $candidat->id) }}" method="POST" class="text-start" id="modifierContactForm{{ $candidat->id }}" enctype="multipart/form-data">
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-md-6 mb-3">
                                                                ...
                                                                <input type="text" name="prenoms" id="prenoms" class="form-control"
                                                                    value="{{ old('prenoms') ?? $candidat->prenom }}" required>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-md-6 mb-3">
                                                                ...
                                                                <input type="text" name="pays" id="pays" class="form-control" value="{{ old('pays') ?? $candidat->pays }}" disabled required>
                                                            </div>
                                                            ...
                                                            <div class="col-md-6 mb-3">
                                                                ...
                                                                <input type="text" name="ville" id="ville" class="form-control"
                                                                    value="{{ old('ville') ?? $candidat->ville }}" required>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="row">
                                                            <div class="col-md-6 mb-3">
                                                                ...
                                                                <input type="tel" name="numero_telephone" id="numero_telephone" class="form-control"
                                                                    value="{{ old('numero_telephone') ?? $candidat->numero_telephone }}" required>
                                                            </div>
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-md-6 mb-3">
                                                                ...
                                                                <input type="text" name="profession" id="profession" class="form-control"
                                                                    value="{{ old('profession') ?? $candidat->profession }}" required>
                                                            </div>
                                    
                                    
                                                            <div class="col-md-6 mb-3">
                                                                <label for="date_rdv" class="form-label">Date Rendez Vous</label>
                                                                <input type="date" name="date_rdv" id="date_rdv" class="form-control" value="{{ old('date_rdv') ?? $candidat->date_rdv }}">
                                                            </div>
                                                        </div>
                                                </div>
