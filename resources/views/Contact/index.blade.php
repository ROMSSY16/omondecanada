                                                        ...
                                                        <div class="row">
                                                            <div class="col-md-8 mb-3">
                                                                <div class="form-group">
                                                                    ...
                                                                    <select name="type_procedure" id="type_procedure" class="form-control" required>
                                                                        <option value="" disabled {{ old('type_procedure') ? '' : 'selected' }}>Choisissez le type de procedure</option>
                                                                        @foreach($type_procedures as $item)
                                                                            <option value="{{ $item->id }}" {{ old('type_procedure', $candidat->typeProcedure->id) == $item->id ? 'selected' : '' }}>
                                                                                {{ $item->label }}
                                                                            </option>
                                                                        @endforeach
                                                                    </select>
                                                                    <div class="invalid-feedback">
                                                                        Veuillez selectionner le type de procedure
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            <div class="col-md-4 mb-3">
                        ...
                        <div class="col-md-8 mb-3">
                            <div class="form-group">
                                ...
                                <select name="type_procedure" id="type_procedure" class="form-control" required>
                                    <option value="" disabled {{ old('type_procedure') ? '' : 'selected' }}>Choisissez le type de procedure </option>
                                    @foreach($type_procedures as $item)
                                        <option value="{{ $item->id }}" {{ old('type_procedure') == $item->id ? 'selected' : '' }}>
                                            {{ $item->label }}
                                        </option>
                                    @endforeach
                                </select>
